 ...
 * @author LENOVO
 */
public class formDataAuthor extends javax.swing.JDialog {
    BufferedImage image;
    String path;
    byte[] bitArray = null;
    
    /**
     * Creates new form formDataAuthor2
     */
    public formDataAuthor() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btn_cancelInpAuthor = new javax.swing.JButton();
        btn_InsertFormAuthor = new javax.swing.JButton();
        btn_ClearFormAuthor = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);

        label_JudulFormAuthor.setFont(new java.awt.Font("Myriad Pro", 2, 24)); // NOI18N
        label_JudulFormAuthor.setText("Form Insert Data Author");
        ...
        btn_cancelInpAuthor.setText("<< Back");
        btn_cancelInpAuthor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_cancelInpAuthorActionPerformed(evt);
            }
        });

        btn_InsertFormAuthor.setText("Insert");
        btn_InsertFormAuthor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_InsertFormAuthorActionPerformed(evt);
            }
        });

        btn_ClearFormAuthor.setText("Clear");
        btn_ClearFormAuthor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_ClearFormAuthorActionPerformed(evt);
            }
        });
                ...
                .addGroup(form_AuthorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(form_AuthorLayout.createSequentialGroup()
                        .addGroup(form_AuthorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(form_AuthorLayout.createSequentialGroup()
                                .addGap(26, 26, 26)
                                .addComponent(btn_InsertFormAuthor)
                                .addGap(18, 18, 18)
                                .addComponent(btn_ClearFormAuthor)
                                .addGap(18, 18, 18)
                                .addComponent(btn_cancelInpAuthor)))
    ...
    private void btn_cancelInpAuthorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cancelInpAuthorActionPerformed
        // TODO add your handling code here:
        dispose();
        MainMenu menu = new MainMenu();
        menu.setVisible(true);
        
    }//GEN-LAST:event_btn_cancelInpAuthorActionPerformed

    private void btn_InsertFormAuthorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_InsertFormAuthorActionPerformed
        // TODO add your handling code here:
        if ((txtField_inpNama.getText().equals("")) || (txtField_dirGambarAuthor.getText().equals("")) || (txtField_inpJmlhBuku.getText().equals(""))){
            getToolkit().beep();
            ...
            try {
                ...
                query.insert(dataauthor);
                
                imgInpAuthor.setIcon(null); 
                txtField_dirGambarAuthor.setText("");
                txtField_inpNama.setText("");
                txtField_inpJmlhBuku.setText("");   
    ...
    }//GEN-LAST:event_btn_InsertFormAuthorActionPerformed
    ...
    private void btn_ClearFormAuthorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ClearFormAuthorActionPerformed
        // TODO add your handling code here:
        txtField_inpNama.setText("");
        txtField_inpJmlhBuku.setText("");
        txtField_dirGambarAuthor.setText("");
        imgInpAuthor.setIcon(null);
    }//GEN-LAST:event_btn_ClearFormAuthorActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formDataAuthor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton btn_ClearFormAuthor;
    private javax.swing.JButton btn_InsertFormAuthor;
    private javax.swing.JButton btn_cancelInpAuthor;
